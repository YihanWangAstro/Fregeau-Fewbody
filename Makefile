...
all: cluster triplebin binbin binsingle binsingle_simple sigma_binsingle triple
...
clean:
	...
	sigma_binsingle.o cluster triplebin binbin binsingle sigma_binsingle \
	triple binsingle_simple.o binsingle_simple
